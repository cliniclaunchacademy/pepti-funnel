...
export default function Questions() {
  return (
    <motion.section
      ...
      className="w-full flex items-center justify-center my-16 lg:my-24 px-10 lg:px-0 mb-0 lg:mb-0"
      id="questions"
    >
      <div className="flex flex-col items-center justify-center w-full max-w-300 gap-8 lg:gap-12">
        ...
        <motion.div variants={slideInRight} className="w-full rounded-md overflow-hidden">
          <div data-tf-live="01KSVN8SWB4QD6T7D26VKTWE6N" className="w-full h-full min-h-150" />
        </motion.div>
      </div>

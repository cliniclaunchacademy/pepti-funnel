  ...
  return (
    ...
    >
      <div className="flex items-center justify-center flex-col w-full max-w-300">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center w-full py-8 lg:py-12 gap-6 lg:gap-8">
    ...
    `}
              ...
              <h4
                className={`font-sans text-black font-medium text-base lg:text-lg leading-relaxed ${
                  step.labelClass ?? ""
                }`}
              >
                {step.label}

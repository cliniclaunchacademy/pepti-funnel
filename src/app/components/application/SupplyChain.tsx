...
export default function SupplyChain() {
  return (
    ...
    >
      <div
        className="relative w-full max-w-300 rounded-2xl pl-120 pr-16 py-11 min-h-72 flex items-center"
        style={{
      ...
      >
        ...
        <div className="flex-1 text-end">
          <motion.h2 variants={fadeUp} className="font-sans text-6xl text-end text-black font-medium leading-none">

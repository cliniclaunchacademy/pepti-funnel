...
export default function SupplyChain() {
  return (
    ...
    >
      <div
        className="relative w-full max-w-300 rounded-2xl pl-24 pr-4 py-6 lg:pl-120 lg:pr-16 lg:py-11 lg:min-h-72 flex items-center overflow-hidden lg:overflow-visible"
        style={{
      ...
      >
        <motion.div
          ...
          className="absolute -left-4 top-auto bottom-0 h-[200px] lg:top-auto lg:bottom-0 lg:w-125 lg:h-auto pointer-events-none"
        >
          <Image
            src="/doctor.png"
            alt="Practitioner"
        ...
        <div className="flex-1 text-end">
          ...
          <motion.p
            variants={fadeUp}
            className="mt-3 lg:mt-6 max-w-lg ml-auto w-[74%] lg:w-[70%] font-sans text-black text-[8px] lg:text-xl leading-snug"
          >
